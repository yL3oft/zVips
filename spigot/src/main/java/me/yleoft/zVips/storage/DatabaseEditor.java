...
public class DatabaseEditor extends DatabaseConnection {
    ...
    public void createTable(String table, String coluns) {
        try (Connection con = getConnection();
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error creating table: " + table, e);
        }
    }
    ...
    public int setKey(String key, String vip, long duration, int uses, @Nullable String uuid) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error setting key: " + key, e);
        }
    ...
    public int decreaseUses(KEY key) {
        ...
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error decreasing key uses for key: " + key, e);
        }
        return newUses;
    }
    ...
    public KEY getKey(int id) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error retrieving key with ID: " + id, e);
        }
        return null;
    }
    public KEY getKey(String key) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error retrieving key with token: " + key, e);
        }
        return null;
    }
        ...
        try (Connection con = getConnection()) {
            if (isInTable(databaseTable(), "ID", id)) {
                ...
                try (PreparedStatement ps = con.prepareStatement("UPDATE " + databaseTable() + " SET PLAYER=? WHERE ID=?")) {
                    ...
                    if(zVipsBukkit.cfgu.enableLogs()) {
                        LogUtils utils = LogManager.createFile(zVipsBukkit.transfers);
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error transferring key with ID: " + id + " to player: " + p.getName(), e);
        }
    }
    ...
    public List<KEY> getUsableKeys(OfflinePlayer p) {
        ...
        try (Connection con = getConnection();) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error retrieving keys for player: " + p.getName(), e);
        }
        return keys;
    }
    ...
    public List<KEY> getKeys(@Nullable OfflinePlayer p) {
        ...
        try (Connection con = getConnection();) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error retrieving keys" + (p != null ? " for player: " + p.getName() : ""), e);
        }
        return keys;
    }
    ...
    public void deleteKey(int id) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error deleting key with id: " + id, e);
        }
    }
    //</editor-fold>
    ...
    public void setVIP(OfflinePlayer p, VIP vip) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error adding points for player: " + p.getName(), e);
        }
    }
    ...
    public long getDuration(OfflinePlayer p, String vip) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error getting player "+p.getName()+"'s current active VIP", e);
        }
        return 0L;
    }
    ...
    public void removePoints(OfflinePlayer p, int points) {
        try {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error removing points for player: " + p.getName(), e);
        }
    }
    ...
    public void resetPoints(OfflinePlayer p) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error resetting points for player: " + p.getName(), e);
        }
    }
    ...
    public int increaseActivated(OfflinePlayer p) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error increasing current key ID", e);
        }
        return getCurrentKeyID();
    }
    ...
    public int getCurrentActivated(OfflinePlayer p) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error retrieving current key ID", e);
        }
        return 0;
    }
    //</editor-fold>
    ...
    public void setPVPoints(int points) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error setting party vip points", e);
        }
    }
    ...
    public void addPVPoints(int points) {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error adding party vip points", e);
        }
    }
    ...
    public void removePVPoints(int points) {
        try {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error removing party vip points", e);
        }
    }
    ...
    public void resetPVPoints() {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error resetting party vip points", e);
        }
    }
    ...
    public int getPVPoints() {
        try (Connection con = getConnection()) {
            ...
            zVipsBukkit.getInstance().getLogger().log(Level.SEVERE, "Error getting party vip points", e);
        }
        return 0;
    }
    //</editor-fold>
