...
public final class zVips extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        dbe.createTable(
                db.databaseTable3(),
                "(ID INT AUTO_INCREMENT, UUID VARCHAR(36) NOT NULL, VIP VARCHAR(30), DURATION BIGINT NOT NULL DEFAULT 0 CHECK (DURATION >= 0), LASTUPDATE BIGINT NOT NULL DEFAULT 0 CHECK (DURATION >= 0), PRIMARY KEY (ID))"
        );
        dbe.createTable(
                db.databaseTable4(),
